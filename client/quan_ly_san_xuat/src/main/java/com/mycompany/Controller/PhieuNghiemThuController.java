...
import com.mycompany.API.CtPhieuNghiemThuService;
import com.mycompany.API.CtPhieuYcsxService;
import com.mycompany.API.LoSanPhamService;
import com.mycompany.API.PhieuNghiemThuService;
...
import com.mycompany.View.pTaoPhieuNghiemTHu;
...
public class PhieuNghiemThuController {
    ...
    public PhieuNghiemThuController(pTaoPhieuNghiemTHu form) {
        this.form = form;
                ...
                try {
                         if(ValidateJTextField.validateFields(maYc, maPhieu, noiDung)) {
                            if(phieuNghiemThuService.getPhieuNghiemThuByMaPhieu(maPhieu) == null) {
                                PhieuNghiemThu phieuNghiemThu = new PhieuNghiemThu(maPhieu, maYc, formattedDate1, noiDung);
