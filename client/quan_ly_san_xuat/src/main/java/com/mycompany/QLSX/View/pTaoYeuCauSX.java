...
import com.mycompany.QLSX.Controller.ChiTietYeuCauController;
...
public class pTaoYeuCauSX extends javax.swing.JPanel {
   ...
   private DanhSachYeuCauController danhSachYeuCauController;
    public pTaoYeuCauSX(String maNv) {
        this.maNv = maNv;
        initComponents();
        ChiTietYeuCauController chiTietYeuCauController = new ChiTietYeuCauController(this, maNv);
        danhSachYeuCauController = new DanhSachYeuCauController();
