 ...
 * @author Khoahihi79
 */
public class PhieuXuatSpService {
    
    private static final String BASE_URL = "http://localhost:5106/api/phieuxuatsp";
    
    public PhieuXuatSp createPhieuXuatSanPham(PhieuXuatSp phieuXuatSp) throws IOException {
        CloseableHttpClient client = HttpClients.createDefault();
        HttpPost httpPost = new HttpPost(BASE_URL);
        httpPost.setHeader("Content-Type", "application/json");
        
        StringEntity entity = new StringEntity(new ObjectMapper().writeValueAsString(phieuXuatSp), StandardCharsets.UTF_8);
