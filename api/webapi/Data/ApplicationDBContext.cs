...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.MaBl).HasName("PK__BacLuong__272475AFE732C0E3");
        ...
        {
            entity.HasKey(e => e.MaBaoHiem).HasName("PK__BaoHiem__AACE9D88FDF0F71B");
            ...
            entity.HasMany(d => d.MaNvs).WithMany(p => p.MaBaoHiems)
                .UsingEntity<Dictionary<string, object>>(
                    ...
                    j =>
                    {
                        j.HasKey("MaBaoHiem", "MaNv").HasName("PK__NV_BaoHi__18BCC0F8088EE683");
        ...
        {
            entity.HasKey(e => e.MaBp).HasName("PK__BoPhan__272475AB7875D471");
        ...
        {
            entity.HasKey(e => e.MaCd).HasName("PK__ChienDic__27258E040362CBB3");
        ...
        {
            entity.HasKey(e => e.MaChinhSach).HasName("PK__ChinhSac__82663E308116AC0F");
            ...
            entity.HasMany(d => d.MaNvs).WithMany(p => p.MaChinhSaches)
                .UsingEntity<Dictionary<string, object>>(
                    ...
                    j =>
                    {
                        j.HasKey("MaChinhSach", "MaNv").HasName("PK__NV_Chinh__3014634062917A19");
        ...
        {
            entity.HasKey(e => e.MaCv).HasName("PK__ChucVu__27258E7632C5B08C");
        ...
        {
            entity.HasKey(e => new { e.MaNv, e.ThangNam }).HasName("PK__Cong__9A69E4444297F712");
        ...
        {
            entity.HasKey(e => new { e.MaHd, e.MaSp }).HasName("PK__CT_HoaDo__F557F66116767369");
            ...
            entity.HasOne(d => d.MaHdNavigation).WithMany(p => p.CtHoaDons)
                ...
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__CT_HoaDon__MaHD__1EA48E88");

            entity.HasOne(d => d.MaSpNavigation).WithMany(p => p.CtHoaDons)
                .HasForeignKey(d => d.MaSp)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__CT_HoaDon__MaSP__1F98B2C1");
        });

        modelBuilder.Entity<CtdonDh>(entity =>
        {
            entity.HasKey(e => new { e.MaDdh, e.MaSp }).HasName("PK__CTDonDH__EFFA98856DE8980C");
            ...
            entity.HasOne(d => d.MaDdhNavigation).WithMany(p => p.CtdonDhs)
                ...
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__CTDonDH__MaDDH__17036CC0");

            entity.HasOne(d => d.MaSpNavigation).WithMany(p => p.CtdonDhs)
                .HasForeignKey(d => d.MaSp)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__CTDonDH__MaSP__17F790F9");
        });

        modelBuilder.Entity<CtphieuHoan>(entity =>
        {
            entity.HasKey(e => new { e.MaPh, e.MaSp }).HasName("PK__CTPhieuH__F557B77B6506E223");
            ...
            entity.HasOne(d => d.MaPhNavigation).WithMany(p => p.CtphieuHoans)
                ...
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__CTPhieuHoa__MaPH__2645B050");

            entity.HasOne(d => d.MaSpNavigation).WithMany(p => p.CtphieuHoans)
                .HasForeignKey(d => d.MaSp)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__CTPhieuHoa__MaSP__2739D489");
        });

        modelBuilder.Entity<CtphieuNghiemThu>(entity =>
        {
            entity.HasKey(e => new { e.MaPnt, e.SoLo }).HasName("PK__CTPhieuN__F1202B3E548D4135");
        ...
        {
            entity.HasKey(e => new { e.MaPnnvl, e.MaNvl }).HasName("PK__CTPhieuN__2468742D11EA1AD7");
            ...
            entity.HasOne(d => d.MaNvlNavigation).WithMany(p => p.CtphieuNhapNvls)
                ...
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__CTPhieuNh__MaNVL__31B762FC");

            entity.HasOne(d => d.MaPnnvlNavigation).WithMany(p => p.CtphieuNhapNvls)
                .HasForeignKey(d => d.MaPnnvl)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__CTPhieuNh__MaPNN__30C33EC3");
        });

        modelBuilder.Entity<CtphieuXuatNvl>(entity =>
        {
            entity.HasKey(e => new { e.MaPxnvl, e.MaNvl }).HasName("PK__CTPhieuX__F590FDE6CB001C49");
            ...
            entity.HasOne(d => d.MaNvlNavigation).WithMany(p => p.CtphieuXuatNvls)
                .HasForeignKey(d => d.MaNvl)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__CTPhieuXu__MaNVL__3864608B");

            entity.HasOne(d => d.MaPxnvlNavigation).WithMany(p => p.CtphieuXuatNvls)
                .HasForeignKey(d => d.MaPxnvl)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__CTPhieuXu__MaPXN__37703C52");
        });

        modelBuilder.Entity<CtphieuXuatSp>(entity =>
        {
            entity.HasKey(e => new { e.MaPxsp, e.MaSp }).HasName("PK__CTPhieuX__9CD235C5DC71CA7D");
            ...
            entity.HasOne(d => d.MaPxspNavigation).WithMany(p => p.CtphieuXuatSps)
                ...
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__CTPhieuXu__MaPXS__45BE5BA9");

            entity.HasOne(d => d.MaSpNavigation).WithMany(p => p.CtphieuXuatSps)
                .HasForeignKey(d => d.MaSp)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__CTPhieuXua__MaSP__46B27FE2");
        });

        modelBuilder.Entity<CtphieuYcsx>(entity =>
        {
            entity.HasKey(e => new { e.MaYc, e.MaSp }).HasName("PK__CTPhieuY__F55161A4ECC567C3");
        ...
        {
            entity.HasKey(e => new { e.MaPnhh, e.MaSp }).HasName("PK__CTPNHang__62E323D8C768D647");
            ...
            entity.HasOne(d => d.MaPnhhNavigation).WithMany(p => p.CtpnhangHoans)
                ...
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__CTPNHangH__MaPNH__4D5F7D71");

            entity.HasOne(d => d.MaSpNavigation).WithMany(p => p.CtpnhangHoans)
                .HasForeignKey(d => d.MaSp)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__CTPNHangHo__MaSP__4E53A1AA");
        });

        modelBuilder.Entity<DanhMucChi>(entity =>
        {
            entity.HasKey(e => e.MaDmt).HasName("PK__DanhMucC__3D8821A180BBD08C");
        ...
        {
            entity.HasKey(e => e.MaDmt).HasName("PK__DanhMucT__3D8821A18FDA14F9");
        ...
        {
            entity.HasKey(e => e.MaDdh).HasName("PK__DonDH__3D88C8047574DB74");
            ...
            entity.HasOne(d => d.MaKhNavigation).WithMany(p => p.DonDhs)
                ...
                .HasConstraintName("FK__DonDH__MaKH__1332DBDC");

            entity.HasOne(d => d.MaNvNavigation).WithMany(p => p.DonDhs)
                .HasForeignKey(d => d.MaNv)
                .HasConstraintName("FK__DonDH__MaNV__14270015");
        });

        modelBuilder.Entity<HinhAnhQc>(entity =>
        {
            entity.HasKey(e => e.MaAnhQc).HasName("PK__HinhAnhQ__B99466BF82A102F9");
        ...
        {
            entity.HasKey(e => e.MaHd).HasName("PK__HoaDon__2725A6E0C911187D");
            ...
            entity.HasOne(d => d.MaDdhNavigation).WithMany(p => p.HoaDons)
                .HasForeignKey(d => d.MaDdh)
                .HasConstraintName("FK__HoaDon__MaDDH__1AD3FDA4");

            entity.HasOne(d => d.MaNvNavigation).WithMany(p => p.HoaDons)
                .HasForeignKey(d => d.MaNv)
                .HasConstraintName("FK__HoaDon__MaNV__1BC821DD");
        });

        modelBuilder.Entity<HopDong>(entity =>
        {
            entity.HasKey(e => e.MaHopDong).HasName("PK__HopDong__36DD4342CD79AAA4");
        ...
        {
            entity.HasKey(e => e.MaKh).HasName("PK__KhachHan__2725CF1EF029CD2B");
        ...
        {
            entity.HasKey(e => e.SoLo).HasName("PK__LoSanPha__BC3CCBEDDCA75460");
        ...
        {
            entity.HasKey(e => e.MaLoaiKh).HasName("PK__LoaiKH__12250B7EB726C365");
        ...
        {
            entity.HasKey(e => e.MaLoai).HasName("PK__LoaiSP__730A5759E487DB68");
        ...
        {
            entity.HasKey(e => e.MaAnhSp).HasName("PK__MauMaSP__B9947560E7785731");
        ...
        {
            entity.HasKey(e => e.MaNvl).HasName("PK__NguyenVa__3A1978648C2912C8");
        ...
        {
            entity.HasKey(e => e.MaNcc).HasName("PK__NhaCungC__3A185DEB6853C8B7");
        ...
        {
            entity.HasKey(e => e.MaPhieuChi).HasName("PK__PhieuChi__00AC0F1959FD1717");
            ...
            entity.HasOne(d => d.MaDmcNavigation).WithMany(p => p.PhieuChis)
                ...
                .HasConstraintName("FK__PhieuChi__MaDMC__58D1301D");

            entity.HasOne(d => d.MaNvNavigation).WithMany(p => p.PhieuChis)
                .HasForeignKey(d => d.MaNv)
                .HasConstraintName("FK__PhieuChi__MaNV__59C55456");
        });

        modelBuilder.Entity<PhieuChiCongNo>(entity =>
        {
            entity.HasKey(e => e.MaPccn).HasName("PK__PhieuChi__54B176FDCEF7A0F6");
            ...
            entity.HasOne(d => d.MaNccNavigation).WithMany(p => p.PhieuChiCongNos)
                ...
                .HasConstraintName("FK__PhieuChiC__MaNCC__607251E5");

            entity.HasOne(d => d.MaNvNavigation).WithMany(p => p.PhieuChiCongNos)
                .HasForeignKey(d => d.MaNv)
                .HasConstraintName("FK__PhieuChiCo__MaNV__6166761E");
        });

        modelBuilder.Entity<PhieuHoan>(entity =>
        {
            entity.HasKey(e => e.MaPh).HasName("PK__PhieuHoa__2725E7FA687CB76A");
            ...
            entity.HasOne(d => d.MaDdhNavigation).WithMany(p => p.PhieuHoans)
                .HasForeignKey(d => d.MaDdh)
                .HasConstraintName("FK__PhieuHoan__MaDDH__22751F6C");

            entity.HasOne(d => d.MaNvNavigation).WithMany(p => p.PhieuHoans)
                .HasForeignKey(d => d.MaNv)
                .HasConstraintName("FK__PhieuHoan__MaNV__236943A5");
        });

        modelBuilder.Entity<PhieuNghiemThu>(entity =>
        {
            entity.HasKey(e => e.MaPnt).HasName("PK__PhieuNgh__3AE3E78074079AF6");
        ...
        {
            entity.HasKey(e => e.MaPnnvl).HasName("PK__PhieuNha__77C9E3AB7B6D78BB");
            ...
            entity.HasOne(d => d.MaNccNavigation).WithMany(p => p.PhieuNhapNvls)
                .HasForeignKey(d => d.MaNcc)
                .HasConstraintName("FK__PhieuNhap__MaNCC__2DE6D218");

            entity.HasOne(d => d.MaNvNavigation).WithMany(p => p.PhieuNhapNvls)
                .HasForeignKey(d => d.MaNv)
                .HasConstraintName("FK__PhieuNhapN__MaNV__2CF2ADDF");

            entity.HasOne(d => d.MaYcNavigation).WithMany(p => p.PhieuNhapNvls)
                .HasForeignKey(d => d.MaYc)
                .HasConstraintName("FK__PhieuNhapN__MaYC__2BFE89A6");
        });

        modelBuilder.Entity<PhieuNhapSp>(entity =>
        {
            entity.HasKey(e => e.MaPnsp).HasName("PK__PhieuNha__B0913A6836DF2951");
            ...
            entity.HasOne(d => d.MaNvNavigation).WithMany(p => p.PhieuNhapSps)
                .HasForeignKey(d => d.MaNv)
                .HasConstraintName("FK__PhieuNhapS__MaNV__3B40CD36");
            ...
            entity.HasMany(d => d.SoLos).WithMany(p => p.MaPnsps)
                .UsingEntity<Dictionary<string, object>>(
                    ...
                    j =>
                    {
                        j.HasKey("MaPnsp", "SoLo").HasName("PK__CTPhieuN__7B52F6D614ADF8EA");
        ...
        {
            entity.HasKey(e => e.MaPhieuThu).HasName("PK__PhieuThu__1D8B9C695CEFE648");
            ...
            entity.HasOne(d => d.MaDmtNavigation).WithMany(p => p.PhieuThus)
                ...
                .HasConstraintName("FK__PhieuThu__MaDMT__55009F39");

            entity.HasOne(d => d.MaNvNavigation).WithMany(p => p.PhieuThus)
                .HasForeignKey(d => d.MaNv)
                .HasConstraintName("FK__PhieuThu__MaNV__55F4C372");
        });

        modelBuilder.Entity<PhieuThuCongNo>(entity =>
        {
            entity.HasKey(e => e.MaPtcn).HasName("PK__PhieuThu__B3095E35E8017AA6");
            ...
            entity.HasOne(d => d.MaKhNavigation).WithMany(p => p.PhieuThuCongNos)
                .HasForeignKey(d => d.MaKh)
                .HasConstraintName("FK__PhieuThuCo__MaKH__5CA1C101");

            entity.HasOne(d => d.MaNvNavigation).WithMany(p => p.PhieuThuCongNos)
                .HasForeignKey(d => d.MaNv)
                .HasConstraintName("FK__PhieuThuCo__MaNV__5D95E53A");
        });

        modelBuilder.Entity<PhieuXuatNvl>(entity =>
        {
            entity.HasKey(e => e.MaPxnvl).HasName("PK__PhieuXua__A6316A60E5F63BB7");
            ...
            entity.HasOne(d => d.MaNvNavigation).WithMany(p => p.PhieuXuatNvls)
                .HasForeignKey(d => d.MaNv)
                .HasConstraintName("FK__PhieuXuatN__MaNV__3493CFA7");
        });

        modelBuilder.Entity<PhieuXuatSp>(entity =>
        {
            entity.HasKey(e => e.MaPxsp).HasName("PK__PhieuXua__4EA06544CB60BB32");
            ...
            entity.HasOne(d => d.MaDdhNavigation).WithMany(p => p.PhieuXuatSps)
                .HasForeignKey(d => d.MaDdh)
                .HasConstraintName("FK__PhieuXuat__MaDDH__41EDCAC5");

            entity.HasOne(d => d.MaNvNavigation).WithMany(p => p.PhieuXuatSps)
                .HasForeignKey(d => d.MaNv)
                .HasConstraintName("FK__PhieuXuatS__MaNV__42E1EEFE");
        });

        modelBuilder.Entity<PhieuYcsx>(entity =>
        {
            entity.HasKey(e => e.MaYc).HasName("PK__PhieuYCS__2723312529DDA149");
        ...
        {
            entity.HasKey(e => e.MaPhieuKtkl).HasName("PK__phieuktk__8F85A1C4A0ED0C79");
        ...
        {
            entity.HasKey(e => e.MaPhuCap).HasName("PK__PhuCap__F97D973893AD3E07");
            ...
            entity.HasMany(d => d.MaNvs).WithMany(p => p.MaPhuCaps)
                .UsingEntity<Dictionary<string, object>>(
                    ...
                    j =>
                    {
                        j.HasKey("MaPhuCap", "MaNv").HasName("PK__NV_PhuCa__4B0FCA480A67CD5C");
                        j.ToTable("NV_PhuCap");
        ...
        {
            entity.HasKey(e => e.MaPnhh).HasName("PK__PNHangHo__B091735961D306A9");
            ...
            entity.HasOne(d => d.MaDdhNavigation).WithMany(p => p.PnhangHoans)
                .HasForeignKey(d => d.MaDdh)
                .HasConstraintName("FK__PNHangHoa__MaDDH__498EEC8D");

            entity.HasOne(d => d.MaNvNavigation).WithMany(p => p.PnhangHoans)
                .HasForeignKey(d => d.MaNv)
                .HasConstraintName("FK__PNHangHoan__MaNV__4A8310C6");
        });

        modelBuilder.Entity<QtcongTac>(entity =>
        {
            entity.HasKey(e => e.MaQt).HasName("PK__QTCongTa__2725F85AEB574041");
        ...
        {
            entity.HasKey(e => e.MaSp).HasName("PK__SanPham__2725081C893E8C2C");
        ...
        {
            entity.HasKey(e => e.Username).HasName("PK__TaiKhoan__536C85E53A6348D2");
        ...
        {
            entity.HasKey(e => e.MaNv).HasName("PK__ThongTin__2725D70AC1C0BABB");
        ...
        {
            entity.HasKey(e => e.MaUuDai).HasName("PK__UuDai__9650302A8F9A0EFB");
            ...
            entity.HasMany(d => d.MaCds).WithMany(p => p.MaUuDais)
                .UsingEntity<Dictionary<string, object>>(
                    ...
                    j =>
                    {
                        j.HasKey("MaUuDai", "MaCd").HasName("PK__UuDai_Ch__C42268CAF347CDA1");
            ...
            entity.HasMany(d => d.MaLoaiKhs).WithMany(p => p.MaUuDais)
                .UsingEntity<Dictionary<string, object>>(
                    ...
                    j =>
                    {
                        j.HasKey("MaUuDai", "MaLoaiKh").HasName("PK__UuDai_Lo__6772609DEC107529");
